 ...
 */
   ...
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " (coolio986, Github)"

  /**
 * Defines the version of this Marlin build. Not to be confused with
 * Marlin's own build number, e.g. 2.0.x.
 */
 #define CUSTOM_BUILD_VERSION "v1.4.8"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2019-12-18"
 ...
 */
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/coolio986/Marlin_2.0.x_Anycubic_Chiron"
